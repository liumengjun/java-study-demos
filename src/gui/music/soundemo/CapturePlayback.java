...
public class CapturePlayback extends JPanel implements ActionListener, ControlContext {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (obj.equals(auB)) {
            saveToFile(textField.getText().trim()+".au", AudioFileFormat.Type.AU);
        } else if (obj.equals(aiffB)) {
            saveToFile(textField.getText().trim()+".aiff", AudioFileFormat.Type.AIFF);
    ...
    class Capture implements Runnable {
        ...
        public void run() {
            ...
            while (thread != null) {
                ...
                samplingGraph.createWaveForm(data);
            }
